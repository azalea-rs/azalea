...
declare_state_packets!(
    ...
    Clientbound => {
        ...
        0x17: clientbound_damage_event_packet::ClientboundDamageEventPacket,
        ...
        0x1a: clientbound_disguised_chat_packet::ClientboundDisguisedChatPacket,
        0x1b: clientbound_entity_event_packet::ClientboundEntityEventPacket,
        0x1c: clientbound_explode_packet::ClientboundExplodePacket,
        0x1d: clientbound_forget_level_chunk_packet::ClientboundForgetLevelChunkPacket,
        0x1e: clientbound_game_event_packet::ClientboundGameEventPacket,
        0x1f: clientbound_horse_screen_open_packet::ClientboundHorseScreenOpenPacket,
        0x20: clientbound_hurt_animation_packet::ClientboundHurtAnimationPacket,
        0x21: clientbound_initialize_border_packet::ClientboundInitializeBorderPacket,
        0x22: clientbound_keep_alive_packet::ClientboundKeepAlivePacket,
        0x23: clientbound_level_chunk_with_light_packet::ClientboundLevelChunkWithLightPacket,
        0x24: clientbound_level_event_packet::ClientboundLevelEventPacket,
        0x25: clientbound_level_particles_packet::ClientboundLevelParticlesPacket,
        0x26: clientbound_light_update_packet::ClientboundLightUpdatePacket,
        0x27: clientbound_login_packet::ClientboundLoginPacket,
        0x28: clientbound_map_item_data_packet::ClientboundMapItemDataPacket,
        0x29: clientbound_merchant_offers_packet::ClientboundMerchantOffersPacket,
        0x2a: clientbound_move_entity_pos_packet::ClientboundMoveEntityPosPacket,
        0x2b: clientbound_move_entity_pos_rot_packet::ClientboundMoveEntityPosRotPacket,
        0x2c: clientbound_move_entity_rot_packet::ClientboundMoveEntityRotPacket,
        0x2d: clientbound_move_vehicle_packet::ClientboundMoveVehiclePacket,
        0x2e: clientbound_open_book_packet::ClientboundOpenBookPacket,
        0x2f: clientbound_open_screen_packet::ClientboundOpenScreenPacket,
        0x30: clientbound_open_sign_editor_packet::ClientboundOpenSignEditorPacket,
        0x31: clientbound_ping_packet::ClientboundPingPacket,
        0x32: clientbound_place_ghost_recipe_packet::ClientboundPlaceGhostRecipePacket,
        0x33: clientbound_player_abilities_packet::ClientboundPlayerAbilitiesPacket,
        0x34: clientbound_player_chat_packet::ClientboundPlayerChatPacket,
        0x35: clientbound_player_combat_end_packet::ClientboundPlayerCombatEndPacket,
        0x36: clientbound_player_combat_enter_packet::ClientboundPlayerCombatEnterPacket,
        0x37: clientbound_player_combat_kill_packet::ClientboundPlayerCombatKillPacket,
        0x38: clientbound_player_info_remove_packet::ClientboundPlayerInfoRemovePacket,
        0x39: clientbound_player_info_update_packet::ClientboundPlayerInfoUpdatePacket,
        0x3a: clientbound_player_look_at_packet::ClientboundPlayerLookAtPacket,
        0x3b: clientbound_player_position_packet::ClientboundPlayerPositionPacket,
        0x3c: clientbound_recipe_packet::ClientboundRecipePacket,
        0x3d: clientbound_remove_entities_packet::ClientboundRemoveEntitiesPacket,
        0x3e: clientbound_remove_mob_effect_packet::ClientboundRemoveMobEffectPacket,
        0x3f: clientbound_resource_pack_packet::ClientboundResourcePackPacket,
        0x40: clientbound_respawn_packet::ClientboundRespawnPacket,
        0x41: clientbound_rotate_head_packet::ClientboundRotateHeadPacket,
        0x42: clientbound_section_blocks_update_packet::ClientboundSectionBlocksUpdatePacket,
        0x43: clientbound_select_advancements_tab_packet::ClientboundSelectAdvancementsTabPacket,
        0x44: clientbound_server_data_packet::ClientboundServerDataPacket,
        0x45: clientbound_set_action_bar_text_packet::ClientboundSetActionBarTextPacket,
        0x46: clientbound_set_border_center_packet::ClientboundSetBorderCenterPacket,
        0x47: clientbound_set_border_lerp_size_packet::ClientboundSetBorderLerpSizePacket,
        0x48: clientbound_set_border_size_packet::ClientboundSetBorderSizePacket,
        0x49: clientbound_set_border_warning_delay_packet::ClientboundSetBorderWarningDelayPacket,
        0x4a: clientbound_set_border_warning_distance_packet::ClientboundSetBorderWarningDistancePacket,
        0x4b: clientbound_set_camera_packet::ClientboundSetCameraPacket,
        0x4c: clientbound_set_carried_item_packet::ClientboundSetCarriedItemPacket,
        0x4d: clientbound_set_chunk_cache_center_packet::ClientboundSetChunkCacheCenterPacket,
        0x4e: clientbound_set_chunk_cache_radius_packet::ClientboundSetChunkCacheRadiusPacket,
        0x4f: clientbound_set_default_spawn_position_packet::ClientboundSetDefaultSpawnPositionPacket,
        0x50: clientbound_set_display_objective_packet::ClientboundSetDisplayObjectivePacket,
        0x51: clientbound_set_entity_data_packet::ClientboundSetEntityDataPacket,
        0x52: clientbound_set_entity_link_packet::ClientboundSetEntityLinkPacket,
        0x53: clientbound_set_entity_motion_packet::ClientboundSetEntityMotionPacket,
        0x54: clientbound_set_equipment_packet::ClientboundSetEquipmentPacket,
        0x55: clientbound_set_experience_packet::ClientboundSetExperiencePacket,
        0x56: clientbound_set_health_packet::ClientboundSetHealthPacket,
        0x57: clientbound_set_objective_packet::ClientboundSetObjectivePacket,
        0x58: clientbound_set_passengers_packet::ClientboundSetPassengersPacket,
        0x59: clientbound_set_player_team_packet::ClientboundSetPlayerTeamPacket,
        0x5a: clientbound_set_score_packet::ClientboundSetScorePacket,
        0x5b: clientbound_set_simulation_distance_packet::ClientboundSetSimulationDistancePacket,
        0x5c: clientbound_set_subtitle_text_packet::ClientboundSetSubtitleTextPacket,
        0x5d: clientbound_set_time_packet::ClientboundSetTimePacket,
        0x5e: clientbound_set_title_text_packet::ClientboundSetTitleTextPacket,
        0x5f: clientbound_set_titles_animation_packet::ClientboundSetTitlesAnimationPacket,
        0x60: clientbound_sound_entity_packet::ClientboundSoundEntityPacket,
        0x61: clientbound_sound_packet::ClientboundSoundPacket,
        0x62: clientbound_stop_sound_packet::ClientboundStopSoundPacket,
        0x63: clientbound_system_chat_packet::ClientboundSystemChatPacket,
        0x64: clientbound_tab_list_packet::ClientboundTabListPacket,
        0x65: clientbound_tag_query_packet::ClientboundTagQueryPacket,
        0x66: clientbound_take_item_entity_packet::ClientboundTakeItemEntityPacket,
        0x67: clientbound_teleport_entity_packet::ClientboundTeleportEntityPacket,
        0x68: clientbound_update_advancements_packet::ClientboundUpdateAdvancementsPacket,
        0x69: clientbound_update_attributes_packet::ClientboundUpdateAttributesPacket,
        0x6a: clientbound_update_enabled_features_packet::ClientboundUpdateEnabledFeaturesPacket,
        0x6b: clientbound_update_mob_effect_packet::ClientboundUpdateMobEffectPacket,
        0x6c: clientbound_update_recipes_packet::ClientboundUpdateRecipesPacket,
        0x6d: clientbound_update_tags_packet::ClientboundUpdateTagsPacket,
    }
);
