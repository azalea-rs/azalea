...
declare_state_packets!(
    ...
    Clientbound => {
        ...
        0x30: clientbound_move_minecart_packet::ClientboundMoveMinecartPacket,
        0x31: clientbound_move_entity_rot_packet::ClientboundMoveEntityRotPacket,
        0x32: clientbound_move_vehicle_packet::ClientboundMoveVehiclePacket,
        0x33: clientbound_open_book_packet::ClientboundOpenBookPacket,
        0x34: clientbound_open_screen_packet::ClientboundOpenScreenPacket,
        0x35: clientbound_open_sign_editor_packet::ClientboundOpenSignEditorPacket,
        0x36: clientbound_ping_packet::ClientboundPingPacket,
        0x37: clientbound_pong_response_packet::ClientboundPongResponsePacket,
        0x38: clientbound_place_ghost_recipe_packet::ClientboundPlaceGhostRecipePacket,
        0x39: clientbound_player_abilities_packet::ClientboundPlayerAbilitiesPacket,
        0x3a: clientbound_player_chat_packet::ClientboundPlayerChatPacket,
        0x3b: clientbound_player_combat_end_packet::ClientboundPlayerCombatEndPacket,
        0x3c: clientbound_player_combat_enter_packet::ClientboundPlayerCombatEnterPacket,
        0x3d: clientbound_player_combat_kill_packet::ClientboundPlayerCombatKillPacket,
        0x3e: clientbound_player_info_remove_packet::ClientboundPlayerInfoRemovePacket,
        0x3f: clientbound_player_info_update_packet::ClientboundPlayerInfoUpdatePacket,
        0x40: clientbound_player_look_at_packet::ClientboundPlayerLookAtPacket,
        0x41: clientbound_player_position_packet::ClientboundPlayerPositionPacket,
        0x42: clientbound_recipe_packet::ClientboundRecipePacket,
        0x43: clientbound_remove_entities_packet::ClientboundRemoveEntitiesPacket,
        0x44: clientbound_remove_mob_effect_packet::ClientboundRemoveMobEffectPacket,
        0x45: clientbound_reset_score_packet::ClientboundResetScorePacket,
        0x46: clientbound_resource_pack_pop_packet::ClientboundResourcePackPopPacket,
        0x47: clientbound_resource_pack_push_packet::ClientboundResourcePackPushPacket,
        0x48: clientbound_respawn_packet::ClientboundRespawnPacket,
        0x49: clientbound_rotate_head_packet::ClientboundRotateHeadPacket,
        0x4a: clientbound_section_blocks_update_packet::ClientboundSectionBlocksUpdatePacket,
        0x4b: clientbound_select_advancements_tab_packet::ClientboundSelectAdvancementsTabPacket,
        0x4c: clientbound_server_data_packet::ClientboundServerDataPacket,
        0x4d: clientbound_set_action_bar_text_packet::ClientboundSetActionBarTextPacket,
        0x4e: clientbound_set_border_center_packet::ClientboundSetBorderCenterPacket,
        0x4f: clientbound_set_border_lerp_size_packet::ClientboundSetBorderLerpSizePacket,
        0x50: clientbound_set_border_size_packet::ClientboundSetBorderSizePacket,
        0x51: clientbound_set_border_warning_delay_packet::ClientboundSetBorderWarningDelayPacket,
        0x52: clientbound_set_border_warning_distance_packet::ClientboundSetBorderWarningDistancePacket,
        0x53: clientbound_set_camera_packet::ClientboundSetCameraPacket,
        ...
        0x56: clientbound_set_cursor_item_packet::ClientboundSetCursorItemPacket,
        0x57: clientbound_set_default_spawn_position_packet::ClientboundSetDefaultSpawnPositionPacket,
        0x58: clientbound_set_display_objective_packet::ClientboundSetDisplayObjectivePacket,
        0x59: clientbound_set_entity_data_packet::ClientboundSetEntityDataPacket,
        0x5a: clientbound_set_entity_link_packet::ClientboundSetEntityLinkPacket,
        0x5b: clientbound_set_entity_motion_packet::ClientboundSetEntityMotionPacket,
        0x5c: clientbound_set_equipment_packet::ClientboundSetEquipmentPacket,
        0x5d: clientbound_set_experience_packet::ClientboundSetExperiencePacket,
        0x5e: clientbound_set_health_packet::ClientboundSetHealthPacket,
        0x5f: clientbound_set_held_slot_packet::ClientboundSetHeldSlotPacket,
        0x60: clientbound_set_objective_packet::ClientboundSetObjectivePacket,
        0x61: clientbound_set_passengers_packet::ClientboundSetPassengersPacket,
        0x62: clientbound_set_player_inventory_packet::ClientboundSetPlayerInventoryPacket,
        0x63: clientbound_set_player_team_packet::ClientboundSetPlayerTeamPacket,
        0x64: clientbound_set_score_packet::ClientboundSetScorePacket,
        0x65: clientbound_set_simulation_distance_packet::ClientboundSetSimulationDistancePacket,
        0x66: clientbound_set_subtitle_text_packet::ClientboundSetSubtitleTextPacket,
        0x67: clientbound_set_time_packet::ClientboundSetTimePacket,
        0x68: clientbound_set_title_text_packet::ClientboundSetTitleTextPacket,
        0x69: clientbound_set_titles_animation_packet::ClientboundSetTitlesAnimationPacket,
        0x6a: clientbound_sound_entity_packet::ClientboundSoundEntityPacket,
        0x6b: clientbound_sound_packet::ClientboundSoundPacket,
        0x6c: clientbound_start_configuration_packet::ClientboundStartConfigurationPacket,
        0x6d: clientbound_stop_sound_packet::ClientboundStopSoundPacket,
        0x6e: clientbound_store_cookie_packet::ClientboundStoreCookiePacket,
        0x6f: clientbound_system_chat_packet::ClientboundSystemChatPacket,
        0x70: clientbound_tab_list_packet::ClientboundTabListPacket,
        0x71: clientbound_tag_query_packet::ClientboundTagQueryPacket,
        0x72: clientbound_take_item_entity_packet::ClientboundTakeItemEntityPacket,
        0x73: clientbound_teleport_entity_packet::ClientboundTeleportEntityPacket,
        0x74: clientbound_ticking_state_packet::ClientboundTickingStatePacket,
        0x75: clientbound_ticking_step_packet::ClientboundTickingStepPacket,
        0x76: clientbound_transfer_packet::ClientboundTransferPacket,
        0x77: clientbound_update_advancements_packet::ClientboundUpdateAdvancementsPacket,
        0x78: clientbound_update_attributes_packet::ClientboundUpdateAttributesPacket,
        0x79: clientbound_update_mob_effect_packet::ClientboundUpdateMobEffectPacket,
        0x7a: clientbound_update_recipes_packet::ClientboundUpdateRecipesPacket,
        0x7b: clientbound_update_tags_packet::ClientboundUpdateTagsPacket,
        0x7c: clientbound_projectile_power_packet::ClientboundProjectilePowerPacket,
        0x7d: clientbound_custom_report_details_packet::ClientboundCustomReportDetailsPacket,
        0x7e: clientbound_server_links_packet::ClientboundServerLinksPacket
    }
);
