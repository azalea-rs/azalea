...
enum Attribute {
    ...
    GenericBlockInteractionRange => "minecraft:generic.block_interaction_range",
    GenericEntityInteractionRange => "minecraft:generic.entity_interaction_range",
...
enum SoundEvent {
    ...
    EntityArmadilloUnroll => "minecraft:entity.armadillo.unroll",
