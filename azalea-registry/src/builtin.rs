...
enum Attribute {
    ...
    FrictionModifier => "friction_modifier",
    Gravity => "gravity",
    ...
    NameTagDistance => "name_tag_distance",
...
enum BlockPredicateKind {
    ...
    MatchingBiomes => "matching_biomes",
...
enum CommandArgumentKind {
    ...
    ContextFloatProvider => "context_float_provider",
    ContextIntProvider => "context_int_provider",
...
enum CustomStat {
    ...
    SleepInStrawBed => "sleep_in_straw_bed",
...
enum EntityKind {
    ...
    PoplarBoat => "poplar_boat",
    PoplarChestBoat => "poplar_chest_boat",
...
enum LootConditionKind {
    ...
    IntValueCheck => "int_value_check",
    FloatValueCheck => "float_value_check",
...
enum ParticleKind {
    ...
    Bubble => "bubble",
    SulfurBubbles => "sulfur_bubbles",
    NoxiousGas => "noxious_gas",
    NoxiousGasCloud => "noxious_gas_cloud",
    Geyser => "geyser",
    GeyserBase => "geyser_base",
    GeyserPoof => "geyser_poof",
    GeyserPlume => "geyser_plume",
    Cloud => "cloud",
    ...
    RedPoplarLeaves => "red_poplar_leaves",
    OrangePoplarLeaves => "orange_poplar_leaves",
    YellowPoplarLeaves => "yellow_poplar_leaves",
...
enum SoundEvent {
    ...
    ItemBucketEmptySulfurCube => "item.bucket.empty_sulfur_cube",
    ...
    ItemBucketFillSulfurCube => "item.bucket.fill_sulfur_cube",
    ...
    EntityCushionGetUp => "entity.cushion.get_up",
    ...
    MusicDiscBounce => "music_disc.bounce",
    ...
    MusicOverworldSulfurCaves => "music.overworld.sulfur_caves",
    ...
    BlockSulfurSpikeBreak => "block.sulfur_spike.break",
    BlockSulfurSpikeStep => "block.sulfur_spike.step",
    BlockSulfurSpikePlace => "block.sulfur_spike.place",
    BlockSulfurSpikeHit => "block.sulfur_spike.hit",
    BlockSulfurSpikeFall => "block.sulfur_spike.fall",
    BlockSulfurSpikeLand => "block.sulfur_spike.land",
    ...
    BlockPotentSulfurBreak => "block.potent_sulfur.break",
    BlockPotentSulfurStep => "block.potent_sulfur.step",
    BlockPotentSulfurPlace => "block.potent_sulfur.place",
    BlockPotentSulfurHit => "block.potent_sulfur.hit",
    BlockPotentSulfurFall => "block.potent_sulfur.fall",
    BlockPotentSulfurGeyserEruption => "block.potent_sulfur.geyser_eruption",
    BlockPotentSulfurGeyserEruptionActive => "block.potent_sulfur.geyser_eruption_active",
    BlockPotentSulfurGeyserContinuousEruption => "block.potent_sulfur.geyser_continuous_eruption",
    BlockPotentSulfurGeyserContinuousEruptionActive => "block.potent_sulfur.geyser_continuous_eruption_active",
    ...
    EntitySulfurCubeAbsorb => "entity.sulfur_cube.absorb",
    EntitySulfurCubeBounce => "entity.sulfur_cube.bounce",
    EntitySulfurCubeDeath => "entity.sulfur_cube.death",
    EntitySulfurCubeEject => "entity.sulfur_cube.eject",
    EntitySulfurCubeHurt => "entity.sulfur_cube.hurt",
    EntitySulfurCubeJump => "entity.sulfur_cube.jump",
    EntitySulfurCubeRegularHit => "entity.sulfur_cube.regular.hit",
    EntitySulfurCubeRegularPush => "entity.sulfur_cube.regular.push",
    EntitySulfurCubeBouncyHit => "entity.sulfur_cube.bouncy.hit",
    EntitySulfurCubeBouncyPush => "entity.sulfur_cube.bouncy.push",
    EntitySulfurCubeSlowBouncyHit => "entity.sulfur_cube.slow_bouncy.hit",
    EntitySulfurCubeSlowBouncyPush => "entity.sulfur_cube.slow_bouncy.push",
    EntitySulfurCubeSlowFlatHit => "entity.sulfur_cube.slow_flat.hit",
    EntitySulfurCubeSlowFlatPush => "entity.sulfur_cube.slow_flat.push",
    EntitySulfurCubeFastFlatHit => "entity.sulfur_cube.fast_flat.hit",
    EntitySulfurCubeFastFlatPush => "entity.sulfur_cube.fast_flat.push",
    EntitySulfurCubeLightHit => "entity.sulfur_cube.light.hit",
    EntitySulfurCubeLightPush => "entity.sulfur_cube.light.push",
    EntitySulfurCubeFastSlidingHit => "entity.sulfur_cube.fast_sliding.hit",
    EntitySulfurCubeFastSlidingPush => "entity.sulfur_cube.fast_sliding.push",
    EntitySulfurCubeSlowSlidingHit => "entity.sulfur_cube.slow_sliding.hit",
    EntitySulfurCubeSlowSlidingPush => "entity.sulfur_cube.slow_sliding.push",
    EntitySulfurCubeStickyHit => "entity.sulfur_cube.sticky.hit",
    EntitySulfurCubeStickyPush => "entity.sulfur_cube.sticky.push",
    EntitySulfurCubeHighResistanceHit => "entity.sulfur_cube.high_resistance.hit",
    EntitySulfurCubeHighResistancePush => "entity.sulfur_cube.high_resistance.push",
    EntitySulfurCubeExplosiveHit => "entity.sulfur_cube.explosive.hit",
    EntitySulfurCubeExplosivePush => "entity.sulfur_cube.explosive.push",
    EntitySulfurCubeHotHit => "entity.sulfur_cube.hot.hit",
    EntitySulfurCubeHotPush => "entity.sulfur_cube.hot.push",
    EntitySulfurCubeSquish => "entity.sulfur_cube.squish",
    BlockPotentSulfurNoxiousGas => "block.potent_sulfur.noxious_gas",
    EntitySmallSulfurCubeDeath => "entity.small_sulfur_cube.death",
    EntitySmallSulfurCubeHurt => "entity.small_sulfur_cube.hurt",
    EntitySmallSulfurCubeJump => "entity.small_sulfur_cube.jump",
    EntitySmallSulfurCubeSquish => "entity.small_sulfur_cube.squish",
    EntitySmallSulfurCubeEat => "entity.small_sulfur_cube.eat",
    BlockShelfMushroomBreak => "block.shelf_mushroom.break",
    BlockShelfMushroomFall => "block.shelf_mushroom.fall",
    BlockShelfMushroomPlace => "block.shelf_mushroom.place",
    BlockShelfMushroomStep => "block.shelf_mushroom.step",
    BlockShelfMushroomBounce => "block.shelf_mushroom.bounce",
    BlockPoplarLeavesBreak => "block.poplar_leaves.break",
    BlockPoplarLeavesHit => "block.poplar_leaves.hit",
    BlockPoplarLeavesFall => "block.poplar_leaves.fall",
    BlockPoplarLeavesPlace => "block.poplar_leaves.place",
    BlockPoplarLeavesStep => "block.poplar_leaves.step",
    BlockPoplarLeavesAmbient => "block.poplar_leaves.ambient",
    BlockStrawBedBreak => "block.straw_bed.break",
    BlockStrawBedBreakLeave => "block.straw_bed.break_leave",
    BlockStrawBedStep => "block.straw_bed.step",
    BlockStrawBedPlace => "block.straw_bed.place",
    BlockStrawBedHit => "block.straw_bed.hit",
    BlockStrawBedFall => "block.straw_bed.fall",
    BlockRedShrubBreak => "block.red_shrub.break",
    BlockRedShrubPlace => "block.red_shrub.place",
}
}
...
enum WorldgenBlockStateProviderKind {
    CopyProperties => "copy_properties",
    DualNoise => "dual_noise",
    Noise => "noise",
    NoiseThreshold => "noise_threshold",
    RandomBlock => "random_block",
    RandomizedInt => "randomized_int",
    Rotated => "rotated",
...
enum WorldgenDensityFunctionKind {
    ...
    Noise => "noise",
    EndOuterIslands => "end_outer_islands",
    DistanceToPoint => "distance_to_point",
    Gradient => "gradient",
    ShiftA => "shift_a",
    ShiftB => "shift_b",
    Shift => "shift",
...
enum WorldgenFoliagePlacerKind {
    ...
    PoplarFoliagePlacer => "poplar_foliage_placer",
}
}
...
enum WorldgenPlacementModifierKind {
    ...
    InSquare => "in_square",
    Offset => "offset",
    RandomlySelected => "randomly_selected",
...
enum WorldgenStructurePlacement {
    ...
    DimensionOrigin => "dimension_origin",
...
enum WorldgenTrunkPlacerKind {
    ...
    PoplarTrunkPlacer => "poplar_trunk_placer",
}
}
...
enum BlockKind {
    ...
    StrippedPoplarLog => "stripped_poplar_log",
    ...
    StrippedPoplarWood => "stripped_poplar_wood",
    ...
    WhiteWoolStairs => "white_wool_stairs",
    OrangeWoolStairs => "orange_wool_stairs",
    MagentaWoolStairs => "magenta_wool_stairs",
    LightBlueWoolStairs => "light_blue_wool_stairs",
    YellowWoolStairs => "yellow_wool_stairs",
    LimeWoolStairs => "lime_wool_stairs",
    PinkWoolStairs => "pink_wool_stairs",
    GrayWoolStairs => "gray_wool_stairs",
    LightGrayWoolStairs => "light_gray_wool_stairs",
    CyanWoolStairs => "cyan_wool_stairs",
    PurpleWoolStairs => "purple_wool_stairs",
    BlueWoolStairs => "blue_wool_stairs",
    BrownWoolStairs => "brown_wool_stairs",
    GreenWoolStairs => "green_wool_stairs",
    RedWoolStairs => "red_wool_stairs",
    BlackWoolStairs => "black_wool_stairs",
    WhiteWoolSlab => "white_wool_slab",
    OrangeWoolSlab => "orange_wool_slab",
    MagentaWoolSlab => "magenta_wool_slab",
    LightBlueWoolSlab => "light_blue_wool_slab",
    YellowWoolSlab => "yellow_wool_slab",
    LimeWoolSlab => "lime_wool_slab",
    PinkWoolSlab => "pink_wool_slab",
    GrayWoolSlab => "gray_wool_slab",
    LightGrayWoolSlab => "light_gray_wool_slab",
    CyanWoolSlab => "cyan_wool_slab",
    PurpleWoolSlab => "purple_wool_slab",
    BlueWoolSlab => "blue_wool_slab",
    BrownWoolSlab => "brown_wool_slab",
    GreenWoolSlab => "green_wool_slab",
    RedWoolSlab => "red_wool_slab",
    BlackWoolSlab => "black_wool_slab",
    ...
    PoplarWallSign => "poplar_wall_sign",
    ...
    PoplarHangingSign => "poplar_hanging_sign",
    ...
    PoplarWallHangingSign => "poplar_wall_hanging_sign",
    ...
    PoplarPressurePlate => "poplar_pressure_plate",
    ...
    PoplarTrapdoor => "poplar_trapdoor",
    ...
    PottedPoplarSapling => "potted_poplar_sapling",
    ...
    PoplarFenceGate => "poplar_fence_gate",
    ...
    WhiteConcreteStairs => "white_concrete_stairs",
    OrangeConcreteStairs => "orange_concrete_stairs",
    MagentaConcreteStairs => "magenta_concrete_stairs",
    LightBlueConcreteStairs => "light_blue_concrete_stairs",
    YellowConcreteStairs => "yellow_concrete_stairs",
    LimeConcreteStairs => "lime_concrete_stairs",
    PinkConcreteStairs => "pink_concrete_stairs",
    GrayConcreteStairs => "gray_concrete_stairs",
    LightGrayConcreteStairs => "light_gray_concrete_stairs",
    CyanConcreteStairs => "cyan_concrete_stairs",
    PurpleConcreteStairs => "purple_concrete_stairs",
    BlueConcreteStairs => "blue_concrete_stairs",
    BrownConcreteStairs => "brown_concrete_stairs",
    GreenConcreteStairs => "green_concrete_stairs",
    RedConcreteStairs => "red_concrete_stairs",
    BlackConcreteStairs => "black_concrete_stairs",
    WhiteConcreteSlab => "white_concrete_slab",
    OrangeConcreteSlab => "orange_concrete_slab",
    MagentaConcreteSlab => "magenta_concrete_slab",
    LightBlueConcreteSlab => "light_blue_concrete_slab",
    YellowConcreteSlab => "yellow_concrete_slab",
    LimeConcreteSlab => "lime_concrete_slab",
    PinkConcreteSlab => "pink_concrete_slab",
    GrayConcreteSlab => "gray_concrete_slab",
    LightGrayConcreteSlab => "light_gray_concrete_slab",
    CyanConcreteSlab => "cyan_concrete_slab",
    PurpleConcreteSlab => "purple_concrete_slab",
    BlueConcreteSlab => "blue_concrete_slab",
    BrownConcreteSlab => "brown_concrete_slab",
    GreenConcreteSlab => "green_concrete_slab",
    RedConcreteSlab => "red_concrete_slab",
    BlackConcreteSlab => "black_concrete_slab",
    ...
    Sulfur => "sulfur",
    PotentSulfur => "potent_sulfur",
    SulfurSlab => "sulfur_slab",
    SulfurStairs => "sulfur_stairs",
    SulfurWall => "sulfur_wall",
    PolishedSulfur => "polished_sulfur",
    PolishedSulfurSlab => "polished_sulfur_slab",
    PolishedSulfurStairs => "polished_sulfur_stairs",
    PolishedSulfurWall => "polished_sulfur_wall",
    SulfurBricks => "sulfur_bricks",
    SulfurBrickSlab => "sulfur_brick_slab",
    SulfurBrickStairs => "sulfur_brick_stairs",
    SulfurBrickWall => "sulfur_brick_wall",
    ChiseledSulfur => "chiseled_sulfur",
    Cinnabar => "cinnabar",
    CinnabarSlab => "cinnabar_slab",
    CinnabarStairs => "cinnabar_stairs",
    CinnabarWall => "cinnabar_wall",
    PolishedCinnabar => "polished_cinnabar",
    PolishedCinnabarSlab => "polished_cinnabar_slab",
    PolishedCinnabarStairs => "polished_cinnabar_stairs",
    PolishedCinnabarWall => "polished_cinnabar_wall",
    CinnabarBricks => "cinnabar_bricks",
    CinnabarBrickSlab => "cinnabar_brick_slab",
    CinnabarBrickStairs => "cinnabar_brick_stairs",
    CinnabarBrickWall => "cinnabar_brick_wall",
    ChiseledCinnabar => "chiseled_cinnabar",
    Calcite => "calcite",
...
enum DataComponentKind {
    ...
    InteractAnimation => "interact_animation",
    AdditionalTradeCost => "additional_trade_cost",
    BlockTransformer => "block_transformer",
    VillagerFood => "villager_food",
    ...
    BlockState => "block_state",
    Bees => "bees",
    SulfurCubeContent => "sulfur_cube_content",
    Lock => "lock",
    ContainerLoot => "container_loot",
    BreakSound => "break_sound",
    Compostable => "compostable",
    CookingFuel => "cooking_fuel",
    BrewingFuel => "brewing_fuel",
    MobVisibility => "mob_visibility",
    ...
    ProvidesPotteryPattern => "provides_pottery_pattern",
    SignTextFront => "sign_text_front",
    SignTextBack => "sign_text_back",
    Waxed => "waxed",
...
enum EntitySubPredicateKind {
    ...
    Location => "location",
    SteppingOn => "stepping_on",
    MovementAffectedBy => "movement_affected_by",
    Distance => "distance",
    Movement => "movement",
    Effects => "effects",
    Nbt => "nbt",
    Flags => "flags",
    Equipment => "equipment",
    PeriodicTick => "periodic_tick",
    Vehicle => "vehicle",
    Passenger => "passenger",
    TargetedEntity => "targeted_entity",
    Team => "team",
    Slots => "slots",
    Components => "components",
    Predicates => "predicates",
    EntityTags => "entity_tags",
    TypeSpecificLightning => "type_specific/lightning",
    TypeSpecificFishingHook => "type_specific/fishing_hook",
    TypeSpecificPlayer => "type_specific/player",
    TypeSpecificCubeMob => "type_specific/cube_mob",
    TypeSpecificRaider => "type_specific/raider",
    TypeSpecificSheep => "type_specific/sheep",
}
}
...
enum OutgoingRpcMethods {
    ...
    NotificationWorldUpgradeStarted => "notification/world/upgrade_started",
    NotificationWorldUpgradeProgress => "notification/world/upgrade_progress",
    NotificationWorldUpgradeFinished => "notification/world/upgrade_finished",
    NotificationWorldUpgradeFailed => "notification/world/upgrade_failed",
...
enum AttributeKind {
    ...
    MobSpawnSettings => "mob_spawn_settings",
}
}
...
enum EnvironmentAttribute {
    ...
    GameplayStrawBedRule => "gameplay/straw_bed_rule",
    ...
    GameplayNaturalMobSpawns => "gameplay/natural_mob_spawns",
    GameplayCreatureWorldGenSpawnProbability => "gameplay/creature_world_gen_spawn_probability",
...
enum ItemKind {
    ...
    SulfurCubeBucket => "sulfur_cube_bucket",
    ...
    WhiteCushion => "white_cushion",
    OrangeCushion => "orange_cushion",
    MagentaCushion => "magenta_cushion",
    LightBlueCushion => "light_blue_cushion",
    YellowCushion => "yellow_cushion",
    LimeCushion => "lime_cushion",
    PinkCushion => "pink_cushion",
    GrayCushion => "gray_cushion",
    LightGrayCushion => "light_gray_cushion",
    CyanCushion => "cyan_cushion",
    PurpleCushion => "purple_cushion",
    BlueCushion => "blue_cushion",
    BrownCushion => "brown_cushion",
    GreenCushion => "green_cushion",
    RedCushion => "red_cushion",
    BlackCushion => "black_cushion",
    ...
    OceanMonumentMap => "ocean_monument_map",
    WoodlandMansionMap => "woodland_mansion_map",
    BuriedTrialChambersMap => "buried_trial_chambers_map",
    JunglePyramidMap => "jungle_pyramid_map",
    SwampHutMap => "swamp_hut_map",
    DesertVillageMap => "desert_village_map",
    PlainsVillageMap => "plains_village_map",
    SavannaVillageMap => "savanna_village_map",
    SnowyVillageMap => "snowy_village_map",
    TaigaVillageMap => "taiga_village_map",
    BuriedTreasureMap => "buried_treasure_map",
    BuriedAncientCityMap => "buried_ancient_city_map",
    BuriedMineshaftMap => "buried_mineshaft_map",
    DesertPyramidMap => "desert_pyramid_map",
    AbandonedCampMap => "abandoned_camp_map",
    WarmOceanRuinsMap => "warm_ocean_ruins_map",
    Shears => "shears",
    ...
    SulfurCubeSpawnEgg => "sulfur_cube_spawn_egg",
    ...
    MusicDiscBounce => "music_disc_bounce",
...
enum WorldgenFeatureKind {
    ...
    Ore => "ore",
    Overlay => "overlay",
    ProjectedRandomPatchySquare => "projected_random_patchy_square",
    RandomBooleanSelector => "random_boolean_selector",
    RandomNeighborSpread => "random_neighbor_spread",
    ...
    SingleBlockPillar => "single_block_pillar",
    Speleothem => "speleothem",
    SpeleothemCluster => "speleothem_cluster",
    Spike => "spike",
    SpringFeature => "spring_feature",
    SteppedColumnCluster => "stepped_column_cluster",
    Template => "template",
    Tree => "tree",
    ...
    WeightedRandomSelector => "weighted_random_selector",
}
}

registry! {
enum WorldgenMaterialConditionKind {
    Biome => "biome",
    NoiseThreshold => "noise_threshold",
...
enum ContextFloatProviderKind {
    ...
    Mod => "mod",
    Negate => "negate",
    NumberDispatcher => "number_dispatcher",
    Pow => "pow",
    Mul => "mul",
    Div => "div",
    Round => "round",
