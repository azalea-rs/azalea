...
pub static COMPLETES_FIND_TREE_TUTORIAL: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ...
        ItemKind::RedPoplarLeaves,
        ItemKind::OrangePoplarLeaves,
        ItemKind::YellowPoplarLeaves,
...
pub static CONCRETE: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
...
pub static CONCRETE_POWDERS: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
...
pub static DAMPENS_VIBRATIONS: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ...
        ItemKind::RedWool,
        ItemKind::BlackWool,
        ItemKind::WhiteWoolStairs,
        ItemKind::OrangeWoolStairs,
        ItemKind::MagentaWoolStairs,
        ItemKind::LightBlueWoolStairs,
        ItemKind::YellowWoolStairs,
        ItemKind::LimeWoolStairs,
        ItemKind::PinkWoolStairs,
        ItemKind::GrayWoolStairs,
        ItemKind::LightGrayWoolStairs,
        ItemKind::CyanWoolStairs,
        ItemKind::PurpleWoolStairs,
        ItemKind::BlueWoolStairs,
        ItemKind::BrownWoolStairs,
        ItemKind::GreenWoolStairs,
        ItemKind::RedWoolStairs,
        ItemKind::BlackWoolStairs,
        ItemKind::WhiteWoolSlab,
        ItemKind::OrangeWoolSlab,
        ItemKind::MagentaWoolSlab,
        ItemKind::LightBlueWoolSlab,
        ItemKind::YellowWoolSlab,
        ItemKind::LimeWoolSlab,
        ItemKind::PinkWoolSlab,
        ItemKind::GrayWoolSlab,
        ItemKind::LightGrayWoolSlab,
        ItemKind::CyanWoolSlab,
        ItemKind::PurpleWoolSlab,
        ItemKind::BlueWoolSlab,
        ItemKind::BrownWoolSlab,
        ItemKind::GreenWoolSlab,
        ItemKind::RedWoolSlab,
        ItemKind::BlackWoolSlab,
...
pub static GLAZED_TERRACOTTA: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
...
pub static MUSHROOMS: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::BrownMushroom,
        ItemKind::RedMushroom,
        ItemKind::ShelfMushroom,
    ])
});
...
pub static OCELOT_FOOD: LazyLock<RegistryTag<ItemKind>> =
    LazyLock::new(|| RegistryTag::new(vec![ItemKind::Cod, ItemKind::Salmon]));
pub static ORES: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::CoalOre,
...
pub static PLANKS: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ...
        ItemKind::PoplarPlanks,
        ItemKind::BambooPlanks,
        ItemKind::CrimsonPlanks,
        ItemKind::WarpedPlanks,
    ])
});
pub static POPLAR_LOGS: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::PoplarLog,
        ItemKind::StrippedPoplarLog,
        ItemKind::StrippedPoplarWood,
...
pub static SULFUR_CUBE_ARCHETYPE_BOUNCY: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::OakPlanks,
        ItemKind::SprucePlanks,
        ItemKind::BirchPlanks,
...
pub static SULFUR_CUBE_ARCHETYPE_EXPLOSIVE: LazyLock<RegistryTag<ItemKind>> =
    LazyLock::new(|| RegistryTag::new(vec![ItemKind::Tnt]));
pub static SULFUR_CUBE_ARCHETYPE_FAST_FLAT: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::Sponge,
        ItemKind::WetSponge,
        ItemKind::MossBlock,
...
pub static SULFUR_CUBE_ARCHETYPE_FAST_SLIDING: LazyLock<RegistryTag<ItemKind>> =
    LazyLock::new(|| {
        RegistryTag::new(vec![
            ItemKind::SnowBlock,
            ItemKind::PackedIce,
...
pub static SULFUR_CUBE_ARCHETYPE_HIGH_RESISTANCE: LazyLock<RegistryTag<ItemKind>> =
    LazyLock::new(|| RegistryTag::new(vec![ItemKind::SoulSand, ItemKind::SoulSoil]));
pub static SULFUR_CUBE_ARCHETYPE_HOT: LazyLock<RegistryTag<ItemKind>> =
    LazyLock::new(|| RegistryTag::new(vec![ItemKind::MagmaBlock]));
pub static SULFUR_CUBE_ARCHETYPE_LIGHT: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::WhiteWool,
        ItemKind::OrangeWool,
        ItemKind::MagentaWool,
...
pub static SULFUR_CUBE_ARCHETYPE_REGULAR: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::GrassBlock,
        ItemKind::Dirt,
        ItemKind::CoarseDirt,
...
pub static SULFUR_CUBE_ARCHETYPE_SLOW_BOUNCY: LazyLock<RegistryTag<ItemKind>> =
    LazyLock::new(|| {
        RegistryTag::new(vec![
            ItemKind::Stone,
            ItemKind::Granite,
...
pub static SULFUR_CUBE_ARCHETYPE_SLOW_FLAT: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::IronOre,
        ItemKind::DeepslateIronOre,
        ItemKind::CopperOre,
...
pub static SULFUR_CUBE_ARCHETYPE_SLOW_SLIDING: LazyLock<RegistryTag<ItemKind>> =
    LazyLock::new(|| {
        RegistryTag::new(vec![
...
pub static SULFUR_CUBE_ARCHETYPE_STICKY: LazyLock<RegistryTag<ItemKind>> =
    LazyLock::new(|| RegistryTag::new(vec![ItemKind::HoneycombBlock]));
pub static SULFUR_CUBE_FOOD: LazyLock<RegistryTag<ItemKind>> =
    LazyLock::new(|| RegistryTag::new(vec![ItemKind::SlimeBall]));
pub static SULFUR_CUBE_SWALLOWABLE: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::Stone,
        ItemKind::Granite,
        ItemKind::PolishedGranite,
...
pub static WOOL_SLABS: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::WhiteWoolSlab,
        ItemKind::OrangeWoolSlab,
        ItemKind::MagentaWoolSlab,
...
pub static WOOL_STAIRS: LazyLock<RegistryTag<ItemKind>> = LazyLock::new(|| {
    RegistryTag::new(vec![
        ItemKind::WhiteWoolStairs,
        ItemKind::OrangeWoolStairs,
        ItemKind::MagentaWoolStairs,
