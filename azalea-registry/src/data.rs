...
enum RecipeKey {
    ...
    BlackConcreteSlabFromBlackConcreteStonecutting => "black_concrete_slab_from_black_concrete_stonecutting",
    BlackConcreteStairs => "black_concrete_stairs",
    BlackConcreteStairsFromBlackConcreteStonecutting => "black_concrete_stairs_from_black_concrete_stonecutting",
    ...
    BlueConcreteSlabFromBlueConcreteStonecutting => "blue_concrete_slab_from_blue_concrete_stonecutting",
    BlueConcreteStairs => "blue_concrete_stairs",
    BlueConcreteStairsFromBlueConcreteStonecutting => "blue_concrete_stairs_from_blue_concrete_stonecutting",
    ...
    BrownConcreteSlabFromBrownConcreteStonecutting => "brown_concrete_slab_from_brown_concrete_stonecutting",
    BrownConcreteStairs => "brown_concrete_stairs",
    BrownConcreteStairsFromBrownConcreteStonecutting => "brown_concrete_stairs_from_brown_concrete_stonecutting",
    ...
    ChiseledCinnabarFromCinnabarStonecutting => "chiseled_cinnabar_from_cinnabar_stonecutting",
    ...
    ChiseledSulfurFromSulfurStonecutting => "chiseled_sulfur_from_sulfur_stonecutting",
    ...
    CinnabarBrickSlabFromCinnabarBricksStonecutting => "cinnabar_brick_slab_from_cinnabar_bricks_stonecutting",
    CinnabarBrickSlabFromCinnabarStonecutting => "cinnabar_brick_slab_from_cinnabar_stonecutting",
    CinnabarBrickSlabFromPolishedCinnabarStonecutting => "cinnabar_brick_slab_from_polished_cinnabar_stonecutting",
    CinnabarBrickStairs => "cinnabar_brick_stairs",
    CinnabarBrickStairsFromCinnabarBricksStonecutting => "cinnabar_brick_stairs_from_cinnabar_bricks_stonecutting",
    CinnabarBrickStairsFromCinnabarStonecutting => "cinnabar_brick_stairs_from_cinnabar_stonecutting",
    CinnabarBrickStairsFromPolishedCinnabarStonecutting => "cinnabar_brick_stairs_from_polished_cinnabar_stonecutting",
    CinnabarBrickWall => "cinnabar_brick_wall",
    CinnabarBrickWallFromCinnabarBricksStonecutting => "cinnabar_brick_wall_from_cinnabar_bricks_stonecutting",
    CinnabarBrickWallFromCinnabarStonecutting => "cinnabar_brick_wall_from_cinnabar_stonecutting",
    CinnabarBrickWallFromPolishedCinnabarStonecutting => "cinnabar_brick_wall_from_polished_cinnabar_stonecutting",
    CinnabarBricks => "cinnabar_bricks",
    CinnabarBricksFromCinnabarStonecutting => "cinnabar_bricks_from_cinnabar_stonecutting",
    CinnabarBricksFromPolishedCinnabarStonecutting => "cinnabar_bricks_from_polished_cinnabar_stonecutting",
    CinnabarSlab => "cinnabar_slab",
    CinnabarSlabFromCinnabarStonecutting => "cinnabar_slab_from_cinnabar_stonecutting",
    CinnabarStairs => "cinnabar_stairs",
    CinnabarStairsFromCinnabarStonecutting => "cinnabar_stairs_from_cinnabar_stonecutting",
    CinnabarWall => "cinnabar_wall",
    CinnabarWallFromCinnabarStonecutting => "cinnabar_wall_from_cinnabar_stonecutting",
    Clay => "clay",
    Clock => "clock",
    Coal => "coal",
    ...
    CyanConcreteSlabFromCyanConcreteStonecutting => "cyan_concrete_slab_from_cyan_concrete_stonecutting",
    CyanConcreteStairs => "cyan_concrete_stairs",
    CyanConcreteStairsFromCyanConcreteStonecutting => "cyan_concrete_stairs_from_cyan_concrete_stonecutting",
    ...
    GrayConcreteSlabFromGrayConcreteStonecutting => "gray_concrete_slab_from_gray_concrete_stonecutting",
    GrayConcreteStairs => "gray_concrete_stairs",
    GrayConcreteStairsFromGrayConcreteStonecutting => "gray_concrete_stairs_from_gray_concrete_stonecutting",
    ...
    GreenConcreteSlabFromGreenConcreteStonecutting => "green_concrete_slab_from_green_concrete_stonecutting",
    GreenConcreteStairs => "green_concrete_stairs",
    GreenConcreteStairsFromGreenConcreteStonecutting => "green_concrete_stairs_from_green_concrete_stonecutting",
    ...
    LightBlueConcreteSlabFromLightBlueConcreteStonecutting => "light_blue_concrete_slab_from_light_blue_concrete_stonecutting",
    LightBlueConcreteStairs => "light_blue_concrete_stairs",
    LightBlueConcreteStairsFromLightBlueConcreteStonecutting => "light_blue_concrete_stairs_from_light_blue_concrete_stonecutting",
    ...
    LightGrayConcreteSlabFromLightGrayConcreteStonecutting => "light_gray_concrete_slab_from_light_gray_concrete_stonecutting",
    LightGrayConcreteStairs => "light_gray_concrete_stairs",
    LightGrayConcreteStairsFromLightGrayConcreteStonecutting => "light_gray_concrete_stairs_from_light_gray_concrete_stonecutting",
    ...
    LimeConcreteSlabFromLimeConcreteStonecutting => "lime_concrete_slab_from_lime_concrete_stonecutting",
    LimeConcreteStairs => "lime_concrete_stairs",
    LimeConcreteStairsFromLimeConcreteStonecutting => "lime_concrete_stairs_from_lime_concrete_stonecutting",
    ...
    MagentaConcreteSlabFromMagentaConcreteStonecutting => "magenta_concrete_slab_from_magenta_concrete_stonecutting",
    MagentaConcreteStairs => "magenta_concrete_stairs",
    MagentaConcreteStairsFromMagentaConcreteStonecutting => "magenta_concrete_stairs_from_magenta_concrete_stonecutting",
    ...
    OrangeConcreteSlabFromOrangeConcreteStonecutting => "orange_concrete_slab_from_orange_concrete_stonecutting",
    OrangeConcreteStairs => "orange_concrete_stairs",
    OrangeConcreteStairsFromOrangeConcreteStonecutting => "orange_concrete_stairs_from_orange_concrete_stonecutting",
    ...
    PinkConcreteSlabFromPinkConcreteStonecutting => "pink_concrete_slab_from_pink_concrete_stonecutting",
    PinkConcreteStairs => "pink_concrete_stairs",
    PinkConcreteStairsFromPinkConcreteStonecutting => "pink_concrete_stairs_from_pink_concrete_stonecutting",
    ...
    PolishedCinnabarFromCinnabarStonecutting => "polished_cinnabar_from_cinnabar_stonecutting",
    PolishedCinnabarSlab => "polished_cinnabar_slab",
    PolishedCinnabarSlabFromCinnabarStonecutting => "polished_cinnabar_slab_from_cinnabar_stonecutting",
    PolishedCinnabarSlabFromPolishedCinnabarStonecutting => "polished_cinnabar_slab_from_polished_cinnabar_stonecutting",
    PolishedCinnabarStairs => "polished_cinnabar_stairs",
    PolishedCinnabarStairsFromCinnabarStonecutting => "polished_cinnabar_stairs_from_cinnabar_stonecutting",
    PolishedCinnabarStairsFromPolishedCinnabarStonecutting => "polished_cinnabar_stairs_from_polished_cinnabar_stonecutting",
    PolishedCinnabarWall => "polished_cinnabar_wall",
    PolishedCinnabarWallFromCinnabarStonecutting => "polished_cinnabar_wall_from_cinnabar_stonecutting",
    PolishedCinnabarWallFromPolishedCinnabarStonecutting => "polished_cinnabar_wall_from_polished_cinnabar_stonecutting",
    ...
    PolishedSulfurFromSulfurStonecutting => "polished_sulfur_from_sulfur_stonecutting",
    PolishedSulfurSlab => "polished_sulfur_slab",
    PolishedSulfurSlabFromPolishedSulfurStonecutting => "polished_sulfur_slab_from_polished_sulfur_stonecutting",
    PolishedSulfurSlabFromSulfurStonecutting => "polished_sulfur_slab_from_sulfur_stonecutting",
    PolishedSulfurStairs => "polished_sulfur_stairs",
    PolishedSulfurStairsFromPolishedSulfurStonecutting => "polished_sulfur_stairs_from_polished_sulfur_stonecutting",
    PolishedSulfurStairsFromSulfurStonecutting => "polished_sulfur_stairs_from_sulfur_stonecutting",
    PolishedSulfurWall => "polished_sulfur_wall",
    PolishedSulfurWallFromPolishedSulfurStonecutting => "polished_sulfur_wall_from_polished_sulfur_stonecutting",
    PolishedSulfurWallFromSulfurStonecutting => "polished_sulfur_wall_from_sulfur_stonecutting",
    ...
    PurpleConcreteSlabFromPurpleConcreteStonecutting => "purple_concrete_slab_from_purple_concrete_stonecutting",
    PurpleConcreteStairs => "purple_concrete_stairs",
    PurpleConcreteStairsFromPurpleConcreteStonecutting => "purple_concrete_stairs_from_purple_concrete_stonecutting",
    ...
    RabbitStewFromShelfMushroom => "rabbit_stew_from_shelf_mushroom",
    Rail => "rail",
    ...
    RedConcreteSlabFromRedConcreteStonecutting => "red_concrete_slab_from_red_concrete_stonecutting",
    RedConcreteStairs => "red_concrete_stairs",
    RedConcreteStairsFromRedConcreteStonecutting => "red_concrete_stairs_from_red_concrete_stonecutting",
    ...
    SulfurBrickSlabFromPolishedSulfurStonecutting => "sulfur_brick_slab_from_polished_sulfur_stonecutting",
    SulfurBrickSlabFromSulfurBricksStonecutting => "sulfur_brick_slab_from_sulfur_bricks_stonecutting",
    SulfurBrickSlabFromSulfurStonecutting => "sulfur_brick_slab_from_sulfur_stonecutting",
    SulfurBrickStairs => "sulfur_brick_stairs",
    SulfurBrickStairsFromPolishedSulfurStonecutting => "sulfur_brick_stairs_from_polished_sulfur_stonecutting",
    SulfurBrickStairsFromSulfurBricksStonecutting => "sulfur_brick_stairs_from_sulfur_bricks_stonecutting",
    SulfurBrickStairsFromSulfurStonecutting => "sulfur_brick_stairs_from_sulfur_stonecutting",
    SulfurBrickWall => "sulfur_brick_wall",
    SulfurBrickWallFromPolishedSulfurStonecutting => "sulfur_brick_wall_from_polished_sulfur_stonecutting",
    SulfurBrickWallFromSulfurBricksStonecutting => "sulfur_brick_wall_from_sulfur_bricks_stonecutting",
    SulfurBrickWallFromSulfurStonecutting => "sulfur_brick_wall_from_sulfur_stonecutting",
    SulfurBricks => "sulfur_bricks",
    SulfurBricksFromPolishedSulfurStonecutting => "sulfur_bricks_from_polished_sulfur_stonecutting",
    SulfurBricksFromSulfurStonecutting => "sulfur_bricks_from_sulfur_stonecutting",
    SulfurFromSulfurSpikes => "sulfur_from_sulfur_spikes",
    SulfurSlab => "sulfur_slab",
    SulfurSlabFromSulfurStonecutting => "sulfur_slab_from_sulfur_stonecutting",
    SulfurStairs => "sulfur_stairs",
    SulfurStairsFromSulfurStonecutting => "sulfur_stairs_from_sulfur_stonecutting",
    SulfurWall => "sulfur_wall",
    SulfurWallFromSulfurStonecutting => "sulfur_wall_from_sulfur_stonecutting",
    ...
    WhiteConcreteSlabFromWhiteConcreteStonecutting => "white_concrete_slab_from_white_concrete_stonecutting",
    WhiteConcreteStairs => "white_concrete_stairs",
    WhiteConcreteStairsFromWhiteConcreteStonecutting => "white_concrete_stairs_from_white_concrete_stonecutting",
    ...
    YellowConcreteSlabFromYellowConcreteStonecutting => "yellow_concrete_slab_from_yellow_concrete_stonecutting",
    YellowConcreteStairs => "yellow_concrete_stairs",
    YellowConcreteStairsFromYellowConcreteStonecutting => "yellow_concrete_stairs_from_yellow_concrete_stonecutting",
...
data_registry! {
SulfurCubeArchetype => "sulfur_cube_archetype",
enum SulfurCubeArchetypeKey {
    Bouncy => "bouncy",
    Explosive => "explosive",
    FastFlat => "fast_flat",
    FastSliding => "fast_sliding",
    HighResistance => "high_resistance",
    Hot => "hot",
    Light => "light",
    Regular => "regular",
    SlowBouncy => "slow_bouncy",
    SlowFlat => "slow_flat",
    SlowSliding => "slow_sliding",
    Sticky => "sticky",
}
}

data_registry! {
DecoratedPotPattern => "decorated_pot_pattern",
enum DecoratedPotPatternKey {
    Angler => "angler",
    Archer => "archer",
    ArmsUp => "arms_up",
    Blade => "blade",
